...
interface InterfaceDbDemographics {
     ...
     */
    fun dbAddDemographics(pPhoneID: Int, pId: Int, pAge: Int, pGender: String, pDominantHand: String, pContext: Context): Long {

        val dataBaseHelper = DataBaseHelper(pContext)

        val success = dataBaseHelper.addDemographics(ModelClassDemographics(pPhoneID, pId, pAge, pGender, pDominantHand))
